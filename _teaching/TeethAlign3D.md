...
collection: teaching
excerpt: "A benchmark dataset, called **TeethAlign3D**, for instance segmentation of 3D buildings in urban scenes, which consists of both roof instances in RGBH images and roof/building instances in 3D mesh models.<br/><img src='/../files/DatasetTeethAlign3D/teaser.jpg'>"
...
Introducation
======
The dataset, called **TeethAlign3D**, contains building instance annotation for both 3D urban scenes and UAV images simultaneously, which makes it unique. We annotated 16 thousand roofs for 608 UAV images, all of which are enhanced with corresponding height maps. We also annotated 892 roofs/buildings for 3D urban scenes, among which more than 600 buildings are attached to others. In such crowded urban scenes, instance segmentation has a more signiﬁcant advantage over semantic segmentation in various applications. Comparisons with existing datasets can be found in our [ICCV](https://californiachen.github.io/publications/2025ICCV/).
...
Citation:
======
Zhenxing Dong, Jiazhou Chen*. &quot; Transformer-based Tooth Alignment Prediction with Occlusion and Collision Constraints.&quot; <i>ICCV</i>. 2025. <a href="{{ '../files/2022TGRS/ref.txt' }}"> {{'BibTex'}}</a>
